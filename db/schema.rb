...
ActiveRecord::Schema.define(version: 2021_11_15_123334) do
  ...
  create_table "cartitems", force: :cascade do |t|
    t.bigint "shopsession_id", null: false
    t.bigint "product_id", null: false
    t.integer "total_quantity"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["product_id"], name: "index_cartitems_on_product_id"
    t.index ["shopsession_id"], name: "index_cartitems_on_shopsession_id"
  end
  ...
  create_table "shopsessions", force: :cascade do |t|
    t.bigint "customer_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["customer_id"], name: "index_shopsessions_on_customer_id"
  end
  ...
  add_foreign_key "shopsessions", "customers"
end
